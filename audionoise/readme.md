...
- reverb (flanger) can be algorithmic with set of delays separated by not one sample as in a convolver but several (impulse response with loudest subset of values, find average base frequency to scatter delays and avoid comb filtering)  
