...
- threshold and limiter for sustainer; realtime pot control for everything; formant filter with initial waveshaper out of distortion; eq out of tube (3 parameters + switch); filter order for bitcrusher (or better filter or waveshaper)  
