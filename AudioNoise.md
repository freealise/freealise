...
- threshold and limiter for sustainer; realtime pot control for everything; harmonizer out of distortion; eq out of tube (3 parameters + switch); filter order for bitcrusher (or biquad filter)  
