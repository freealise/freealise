...
! whistle through peaking+notch filter controlled by pitch detector (~pll) to lower octave (for bass) or 10 comb filters with touchscreen (more can be set in advance)  
