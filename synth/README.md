...
deliberately produce a random sequence or FFT of tune by pitch, length, volume and spectrum, where the probability is a normal distribution and not uniform (meditation or example of genre if programmatic)  
