...
vocabulary: ltwf (with inline decoding) -> google translate to hebrew with corrections, show 64-360-2000 basic words as two way tree, filter next level by basic words in definition (multiple select)  
