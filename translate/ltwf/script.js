...
function InitializeRoots()
{
	...
	AddLayer1Root("near");
	AddLayer1Root("place");
	AddLayer1Root("someplace");
	AddLayer1Root("where");
	AddLayer1Root("in");
	AddLayer1Root("above");
	AddLayer1Root("side");
	AddLayer1Root("on");
	AddLayer1Root("hear heard");
	AddLayer1Root("say said");
	AddLayer1Root("about");
	AddLayer1Root("word");
	AddLayer1Root("true");
	AddLayer1Root("like");
	AddLayer1Root("have has had");
	AddLayer1Root("belong");
	AddLayer1Root("part");
	AddLayer1Root("of");
	AddLayer1Root("do does doing did done");
	AddLayer1Root("with");
	AddLayer1Root("happen");
	AddLayer1Root("because");
	AddLayer1Root("think thought");
	AddLayer1Root("know knew known");
	AddLayer1Root("want");
	AddLayer1Root("can could");
	AddLayer1Root("could");
	AddLayer1Root("cannot");
	AddLayer1Root("bad");
	AddLayer1Root("good");
	AddLayer1Root("well");
	AddLayer1Root("feel felt");
	AddLayer1Root("feeling");
	AddLayer2Root("feelings");
	AddLayer1Root("time");
	AddLayer1Root("when");
	AddLayer1Root("at");
	AddLayer1Root("before");
	AddLayer1Root("short");
	AddLayer1Root("move");
	AddLayer1Root("to");
	AddLayer1Root("I");
	...
	AddLayer1Root("after");
	AddLayer1Root("for");
	AddLayer1Root("moment");
	AddLayer1Root("body");
	AddLayer1Root("die dying");
	AddLayer1Root("dead");
	AddLayer1Root("maybe");
	AddLayer1Root("below");
	AddLayer1Root("that");
