...
Face or makeup color detection for lipsync (points on wax figure = source, face mocap = dest), motion capture of wax figures for auto quality feedback or virtual characters  
