...
vectorizer: downscale image, add color; displace points out or in according to color difference from original (dithering) or merge with depth estimator and blur according to average depth  
