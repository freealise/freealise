function drawScene(gl, programInfo, buffers, texture, cubeRotation, seg, pov) {
  ...
  mat4.rotate(
    ...
    Math.PI + cubeRotation.z, // amount to rotate in radians
    [0, 0, 1]
  ); // axis to rotate around (Z)
  mat4.rotate(
    modelViewMatrix, // destination matrix
    modelViewMatrix, // matrix to rotate
    pov.pitch * 20 + cubeRotation.x * 0.005, // amount to rotate in radians
    [1, 0, 0]
...

  {
    ...
    const offset = 0;
    gl.drawElements(gl.TRIANGLES, Math.pow(seg, 2) * 6, type, offset);
  }
}
