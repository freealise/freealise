...
function main() {
  ...
  void main(void) {
    ...
    highp float r = 1.0 - texelColor.r;
    highp float g = 1.0 - texelColor.g;
    highp float b = 1.0 - texelColor.b;
    highp float a = texelColor.a;
    
    gl_Position = uProjectionMatrix * uModelViewMatrix * aVertexPosition * (r + g + b) / 3.0;
