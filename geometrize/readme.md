polygons (<- triangles) for each color and opacity of posterized image with gradually increasing number of points, or polylines with stroke-dasharray for dithering  
