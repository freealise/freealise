...
for (var i=0; i<divs.length; i++) {
  if (!divs[i].getElementsByTagName('div')[0] && !divs[i].getElementsByTagName('style')[0] && !divs[i].getElementsByTagName('script')[0] && !divs[i].getElementsByTagName('img')[0] && !divs[i].getElementsByTagName('svg')[0] && !divs[i].getElementsByTagName('p')[0] && !divs[i].getElementsByTagName('li')[0] && !divs[i].getElementsByTagName('input')[0] && !divs[i].getElementsByTagName('button')[0]) {
