...
//make dummies from wire (or bamboo ?) with crochet / punch needle / tambour hook needle / kanban needle, and foil (smoothed with nail file or sandpaper and painted in CMYK with white base and added soap), photograph and recolor (morph face or blu-tack / kneaded eraser ?)  
